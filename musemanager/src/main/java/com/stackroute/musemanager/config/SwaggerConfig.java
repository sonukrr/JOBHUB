...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.stackroute.musemanager.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("My Spring Boot REST API", "Documentation of museManager App.", "v1.0.0",
